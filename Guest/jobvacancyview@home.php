        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    ...
                    <span></span> Job vacancies</h3>
					<!---728x90--->
                <div class="tabs mt-5">
                    <ul class="nav nav-pills my-4" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"> Job vacancies</a>
                        </li>
            ...
            inner join tbljobtyperegistration t on v.jobtypeid=t.jobtypeid WHERE  v.poststatus='Active' ");
                ...
                ?> 
                                        <div class="job-post-main row">
                                            ...
                                            <div class="col-md-3 job-single-time text-right">
                                                ...
                                                <a href="jobseekerlogin.php" class="aply-btn ">View Details</a>
                                            </div>
                                        </div>
            <?php
            }
