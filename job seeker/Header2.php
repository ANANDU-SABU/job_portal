...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="css/zoomslider1.css" rel='stylesheet' type='text/css' />
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="logo">
                            <h1>
                                <a class="navbar-brand" href="index.html">
                                    <i class="fab fa-codepen"></i> DOOR4YOU</a>
                            </h1>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-lg-auto text-center">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link" href="companyview.php">companyview
                                        <!-- <span class="sr-only">(current)</span> -->
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="jobtypeview.php">view job vacancies</a>
                                </li>
                                <!-- <li class="nav-item">
                                    <a class="nav-link" href="jobvacancyview.php">Post view</a>
                                </li> -->
                                <li class="nav-item">
                                    <a class="nav-link" href="applicationdetails.php">Application Details</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <!-- <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="companyreg.php"> Create Account</a>
                                        <a class="dropdown-item" href="companylogin.php">Sign In</a>
