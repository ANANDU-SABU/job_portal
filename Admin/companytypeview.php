  ...
  ?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Company Type View Tables </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Company Type View Tables</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Company Type View Tables </li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <a href="companytyperegistration.php" >
    ...
    ?>
                        ...
                        <tr>
                          ...
                          <td> <?php echo $display["companytypename"]; ?></td>
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropupMenuSplitButton2">
                          ...
                          <a class="dropdown-item" href="companytypeedit.php?companytypeid=<?php echo $display['companytypeid'];?>">EDIT </a>
                          <a class="dropdown-item" onclick="return confirm('Are You Sure to Delete this Record?')" 
                          href="companytypedelete.php?companyid=<?php echo $display['companytypeid'];?>">DELETE</a>
