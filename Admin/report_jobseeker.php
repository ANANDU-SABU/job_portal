...
<body>
<form action="Excel/excel_jobseeker.php" method="post">
<div class="logo">
              <a href="./index.php">
                <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
include("config.php");
$s=1;
$sql="select a.districtname,b.* from tbljobseeker b inner join tbldistrict a on b.districtid=a.districtid";
